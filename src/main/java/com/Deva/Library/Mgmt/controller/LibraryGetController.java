...
public class LibraryGetController {
    ...
    public ResponseEntity<Map<String,String>>  getAllCategories(){
        return new ResponseEntity<Map<String,String>>(service.getCategoryiesData(),HttpStatus.FOUND);
    }

    @GetMapping("/AllAuthors")
    public ResponseEntity<Map<String,String>> getAllAuthors(){
        return new ResponseEntity<Map<String,String>>(service.getAllAuthors(),HttpStatus.FOUND);
    }
}
